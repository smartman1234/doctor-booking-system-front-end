...
function DoctorInfo (props) { 
    ...
    var data;
    if(doctor_info) {
        console.log(doctor_info[0].degree);
        // data = <div>{doctor_info[0]["degree"].name_en}</div>
        // <React.Fragment>
        ...
        //                     <h6><i class="fa fa-graduation-cap"></i>{doctor_info[0].degree.name_en}</h6>
        //                     <h6><i class="fa fa-stethoscope"></i>{doctor_info[0].specialist.name_en}</h6>
